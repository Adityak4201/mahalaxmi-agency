            ...
            <div class="row">
              <div class="col-md-6 col-sm-6 col-xs-12">
                <div class="single-top">
                  <p>
                    <i class="fa fa-bandcamp"></i>Welcome to Mahalaxmi Financial
                    Services
                  </p>
                </div>
              </div>
                ...
                <div class="logo">
                  <a href="/">
                    <img
                      ...
                      alt="Mahalaxmi Financial Services"
                    />
                  </a>
                </div>
              ...
              <div class="col-md-9 col-sm-9 col-xs-12">
                <div class="widget-main">
                  ...
                  <div class="single-widget">
                    ...
                    <p>Opening Time</p>
                    <h4>Mon-Sat: 9:30-18:30</h4>
                  </div>
                  <div class="single-widget button">
                    <a href="/query.html" class="btn">
                      Get A Quote
                    </a>
                  </div>
                </div>
                    ...
                    <ul id="nav" class="nav mobile-menu navbar-nav">
                      ...
                      <li>
                        ...
                        <ul class="dropdown">
                          ...
                          <li>
                            <a href="/loans-against-property.html">
                      ...
                      <li>
                        <a href="/gold-loan.html">GOLD LOANS</a>
                      </li>
                      <li>
                        <a href="/loan-processing.html">LOAN PROCESSING</a>
                      </li>
                      <li>
